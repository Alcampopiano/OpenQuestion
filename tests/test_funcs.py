...
schema = {
    "title": "simple survey",
    "settings": {"survey_color": "#2196F3", "thank_you_msg": "#Thank you!"},
    "num_widgets": 2,
    "widgets": [
        {
            "id": 0,
...
def test_save_survey_settings():
    ...
    settings_in_schema = {"survey_color": "#F0F0F0", "thank_you_msg": "#Thank you!"}

    settings_in_datatable = {"opening_date": None, "closing_date": None}
